...
export class BillingInvoice {
  ...
  @Column({ name: 'provider_payment_id', nullable: true }) providerPaymentId: string | null;
  @Column({ name: 'provider_order_id', nullable: true }) providerOrderId: string | null;
  ...
  @Column({ name: 'failed_at', nullable: true }) failedAt: Date | null;
